...
\logo{./resources/pdf/cup-ecs.pdf}
\institute{Center for Understandable Performant Exascale Communication Systems}
\faculty{Faculty of Whatever Sciences}
%\department{Department of Anything but Psychology}
\title{A CPU-ECS Report}
\subtitle{This Report prepared under contract from the With a sleeker title-page}
